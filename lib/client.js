...
function WalletBody({
  ...
  if (payload?.ok === false) {
    const message = payload.error === "no-credential" ? "\u8FD9\u6761\u8DEF\u7531\u6CA1\u6709\u5BC6\u94A5\uFF0C\u67E5\u4E0D\u4E86\u4F59\u989D\u3002" : `\u8D26\u672C\uFF1A${payload.error}`;
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "gww_warn", children: message }),
      payload.detail !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "gww_note", children: payload.detail }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "gww_retry", onClick: onRetry, children: "\u91CD\u8BD5" })
    ] });
  }
  if (snapshot === void 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "gww_note", children: "\u8BFB\u53D6\u4E2D\u2026" });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
    ...
    !snapshot.todayAvailable && snapshot.todayUnavailableReason !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "gww_note", children: "\u7AD9\u70B9\u6CA1\u6709\u5F00\u653E\u4ECA\u65E5\u65E5\u5FD7\u3002" }),
...
function WalletSeat({ wide, useSessions }) {
  ...
  const [payload, setPayload] = (0, import_react.useState)(void 0);
  ...
  const snapshot = payload?.ok === true ? payload : void 0;
  const badgeValue = snapshot?.unlimited === true ? "\u4E0D\u9650" : snapshot !== void 0 ? fmtMoney(snapshot.remaining) : "";
  const reload = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { ref: root, className: wide === false ? "gww_layer gww_rail" : "gww_layer", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "gww_badgeIcon", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconApiOutline14, { size: wide === false ? 16 : 14 }) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "gww_badgeLabel", children: "\u4E2D\u8F6C\u7AD9\u94B1\u5305" }),
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "gww_header", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "gww_title", children: "\u4E2D\u8F6C\u7AD9\u94B1\u5305" }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "gww_body", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WalletBody, { snapshot, payload, error, onRetry: reload }) })
        ]
      }
    )
  ] });
