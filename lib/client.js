...
function WalletBody({
  ...
  if (wallet?.ok === false) {
    const message = wallet.error === "no-credential" ? "\u8FD9\u6761\u8DEF\u7531\u6CA1\u6709\u5BC6\u94A5\uFF0C\u67E5\u4E0D\u4E86\u4F59\u989D\u3002" : wallet.error === "unknown-account" ? "\u540D\u5355\u91CC\u6CA1\u6709\u8FD9\u6761\u8DEF\u7531\u3002" : wallet.error === "no-provider" ? "\u8FD8\u6CA1\u6709\u914D\u7F6E\u5E26\u5730\u5740\u7684\u6A21\u578B\u8DEF\u7531\u3002" : wallet.error === "unknown-software" ? "\u8BA4\u4E0D\u51FA\u8FD9\u4E2A\u7AD9\u8DD1\u7684\u662F\u54EA\u5957\u8D26\u672C\uFF0C\u4E0D\u4F1A\u786C\u731C\u6570\u5B57\u3002" : `\u8D26\u672C\uFF1A${wallet.error}`;
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      picker,
  ...
  (0, import_react.useEffect)(() => {
    ...
    loadWallet(inspectRoute, controller.signal).then(
      (data) => {
        ...
        if (data.wallet.ok === true && (currentRoute === void 0 || data.wallet.route === currentRoute)) {
